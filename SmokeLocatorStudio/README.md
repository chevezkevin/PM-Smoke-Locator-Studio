...
- Mejora el dibujo 3D con silueta solida, linea central y mas vertices reales para que el escape se vea menos raro.
...
```text
dist\PMSmokeLocatorStudio_v0.3.17.exe
```
...
3. Crea un tag, por ejemplo `v0.3.17`.
