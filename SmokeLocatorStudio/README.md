...
- Permite direccion de humo `Automatico` por escape y ajuste por locator desde el editor visual.
...
```text
dist\PMSmokeLocatorStudio_v0.3.9.exe
```
...
3. Crea un tag, por ejemplo `v0.3.9`.
